...
with diagram_container:
    ...
    # 5) 높이 치수선 (H & y_bar)
    # 전체 높이 H
    fig.add_annotation(x=-wall_width/2 - max_x*0.05, y=-H/2, text=f"<b>H={H:.1f}m</b>", showarrow=False, font=dict(size=14, color="black"), bgcolor="white")
